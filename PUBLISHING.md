...
**Status: v2.8.0 is live.** Published 20 August 2026. It replaced v2.4.0, which
...
npm test                                                    # 331, 0 failing
grep VERSION sw.js                                          # reads v2.8.0
...
| **Live now** | tip of `claude/project-onboarding-verify-lz3ob6` | v2.8.0 |

Rolling back from v2.8.0 means republishing from
